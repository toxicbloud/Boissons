...
$sql = "DROP TABLE IF EXISTS compositionCocktail";
echo $pdo->query($sql) ? '<li>RESET table compositionCocktail </li>' : 'COCKTAIL KO';
$sql = "CREATE TABLE IF NOT EXISTS compositionCocktail (
...
echo $pdo->query($sql) ? '<li>Table compositionCocktail crée avec succès</li>' : 'COCKTAIL KO';
echo "</ul>";
